...
class InputboxCustom(TextInput):
    ...
    def on_text_validate(self, *args):
        ...
        if time_dif > INTERVAL_ENTER:
            return

        msg = 'enter is pressed twice quickly'
        logger.i(msg)

        # path = self.root.args[0]
...
class Inputbox(App):
    ...
    def build(self):
        ...
        self.inputbox.background_color = BG_COLOR
        self.inputbox.cursor_width = CURSOR_WIDTH
        self.inputbox.cursor_color = CURSOR_COLOR
        self.inputbox.font_size = FONT_SIZE
        self.inputbox.root = self
